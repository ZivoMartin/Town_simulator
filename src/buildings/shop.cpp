...
Shop::Shop(Game *game, Xy coord) : Building(game->get_img("shop"), game, coord){
    ...
    setting->add_info_zone(new InfoZone(game, {coord.x+255, coord.y+28}, {120, 30}, "Shop level ", game->get_color("lvl_info"), RECT, "lvl"));
    ...
    setting->add_img(new GraphicsPixmapItem(game->get_img("shop"), game->get_view()->get_scene(), {coord.x+306, coord.y+123}));
